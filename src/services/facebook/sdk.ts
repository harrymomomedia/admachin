 ...
 */
/**
 * Login to Facebook using Server-Side OAuth Flow
 * 
 * This redirects the user to our server-side endpoint which handles the secure
 * OAuth handshake with Facebook.
 */
export const loginWithFacebook = (): void => {
    // Redirect to our backend auth endpoint
    // This will redirect to Facebook -> Server Callback -> App with token
