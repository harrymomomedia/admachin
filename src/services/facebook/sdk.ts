 ...
 */
/**
 * Login to Facebook using Server-Side OAuth with config_id
 * 
 * Redirects to our backend which uses Facebook Login for Business configuration.
 * This approach works with Business Manager accounts.
 */
