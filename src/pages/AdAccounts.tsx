                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-64 pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                            />
                        </div>
                        {/* Connect Button */}
                        <button
