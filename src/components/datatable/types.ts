...
export interface ColumnDef<T> {
    ...
    type?: 'draghandle' | 'text' | 'longtext' | 'tiptapeditor' | 'editorjseditor' | 'blocknoteeditor' | 'select' | 'date' | 'url' | 'priority' | 'rating' | 'id' | 'people' | 'thumbnail' | 'filesize' | 'adcopy' | 'media' | 'custom';
